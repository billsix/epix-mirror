/***
 ***  PSTricks.h -- epix2::PSTricks output format
 ***
...
#ifndef EPIX2_PSTRICKS
#define EPIX2_PSTRICKS

#include "Output.h"

namespace ePiX2 {

  class PSTricks : public Format {
  public:
    // default line width (sane value if 0) and color, fill color
    PSTricks(const Length& lw=Length(0), const Color& lc=Black(1),
	     const Color& fc=White(1));
  ...
  }; // end of class PSTricks
} /* end of namespace */

#endif /* EPIX2_PSTRICKS */
