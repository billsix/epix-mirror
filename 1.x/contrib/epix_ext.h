...
namespace ePiX_contrib
{
  ...
  inline double h_scale(double x_posn)
  {
    return truncate((x_posn - x_min)*h_size()/x_size);
  }
  inline double v_scale(double y_posn)
  {
  ...
  class SingleLogCoord:public Coord
  {
     ...
     // Labels
     void label(triple base,triple offset,char *label_text)
            {::label(P(base.x1(),log10(base.x2())),offset,label_text);}
     void label(triple base,char *label_text)
            {::label(P(base.x1(),log10(base.x2())),label_text);}
     void label(triple base,triple offset,char *label_text,epix_label_posn pos)
            {::label(P(base.x1(),log10(base.x2())),offset,label_text,pos);}

     // Marker
     void marker(triple arg,epix_mark_type mark)
            {::marker(P(arg.x1(),log10(arg.x2())),mark);}
  ...
  class DoubleLogCoord:public Coord
  {
     ...
     // Labels
     void label(triple base,triple offset,char *label_text)
            {::label(P(log10(base.x1()),log10(base.x2())),offset,label_text);}
     void label(triple base,char *label_text)
            {::label(P(log10(base.x1()),log10(base.x2())),label_text);}
     void label(triple base,triple offset,char *label_text,epix_label_posn pos)
            {::label(P(log10(base.x1()),log10(base.x2())),offset,label_text,pos);}

     // Marker
     void marker(triple arg,epix_mark_type mark)
            {::marker(P(log10(arg.x1()),log10(arg.x2())),mark);}
