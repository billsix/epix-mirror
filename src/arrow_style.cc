...
// get
double arrowhead_state::width() const { return m_width; }

double arrowhead_state::ratio() const { return m_ratio; }

double arrowhead_state::inset() const { return m_inset; }

bool arrowhead_state::fill() const { return m_fill; }
