...
P __epix_pair2P(const pair& arg) { return P(arg.x1(), arg.x2(), 0); }
...
screen::screen(const screen& sc) : m_screen(sc.m_screen->clone()) {}
...
screen screen::extract(const P& arg1, const P& arg2) const {
  ...
  value.m_screen = new screen_data(m_screen->extract(
      pair(arg1.x1(), arg1.x2()), pair(arg2.x1(), arg2.x2())));
  return value;
}
...
screen screen::extract_diamond(const P& arg1, const P& arg2) const {
  ...
  value.m_screen = new screen_data(m_screen->extract_diamond(
      pair(arg1.x1(), arg1.x2()), pair(arg2.x1(), arg2.x2())));
  return value;
}
...
screen screen::extract_ellipse(const P& arg1, const P& arg2) const {
  ...
  value.m_screen = new screen_data(m_screen->extract_ellipse(
      pair(arg1.x1(), arg1.x2()), pair(arg2.x1(), arg2.x2())));
  return value;
}
...
P screen::tr() const { return __epix_pair2P(m_screen->tr()); }

P screen::tl() const { return __epix_pair2P(m_screen->tl()); }

P screen::bl() const { return __epix_pair2P(m_screen->bl()); }

P screen::br() const { return __epix_pair2P(m_screen->br()); }

P screen::t() const { return __epix_pair2P(m_screen->t()); }

P screen::b() const { return __epix_pair2P(m_screen->b()); }

P screen::l() const { return __epix_pair2P(m_screen->l()); }

P screen::r() const { return __epix_pair2P(m_screen->r()); }

P screen::c() const { return __epix_pair2P(m_screen->c()); }

double screen::h_min() const { return m_screen->h_min(); }

double screen::h_max() const { return m_screen->h_max(); }

double screen::h_size() const { return m_screen->h_size(); }

double screen::h_avg() const { return m_screen->h_avg(); }

double screen::v_min() const { return m_screen->v_min(); }

double screen::v_max() const { return m_screen->v_max(); }

double screen::v_size() const { return m_screen->v_size(); }

double screen::v_avg() const { return m_screen->v_avg(); }
}  // namespace ePiX
