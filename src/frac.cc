...
frac::frac(const int n, const unsigned int d) : m_num(n), m_denom(d) {}
...
int frac::num() const { return m_num; }

unsigned int frac::denom() const { return m_denom; }

bool frac::is_int() const { return __epix_gcd(m_num, m_denom) == m_denom; }

frac operator+(frac arg1, const frac& arg2) { return arg1 += arg2; }

frac operator-(frac arg1) { return arg1 *= -1; }
...
bool operator!=(const frac& u, const frac& v) { return !(u == v); }
