...
// identity
affine::affine() : m_00(0, 0), m_10(1, 0), m_01(0, 1) {}
...
affine& affine::shift(const P& arg) { return shift(pair(arg.x1(), arg.x2())); }
...
affine affine::operator()(const affine& af) const {
  return affine(this->operator()(af.m_10), this->operator()(af.m_01),
