...
// Magenta_Layer
Magenta_Layer::Magenta_Layer(double arg) : m_dens(clip_to_unit(arg)) {}
...
Magenta_Layer* Magenta_Layer::clone() const { return new Magenta_Layer(*this); }

Color_Base::RGB_Densities Magenta_Layer::to_rgb() const {
  return Color_Base::RGB_Densities(1, 1 - m_dens, 1);
}

std::string Magenta_Layer::model() const { return "cmyk"; }
...
// Yellow_Layer
Yellow_Layer::Yellow_Layer(double arg) : m_dens(clip_to_unit(arg)) {}
...
Yellow_Layer* Yellow_Layer::clone() const { return new Yellow_Layer(*this); }

Color_Base::RGB_Densities Yellow_Layer::to_rgb() const {
  return Color_Base::RGB_Densities(1, 1, 1 - m_dens);
}

std::string Yellow_Layer::model() const { return "cmyk"; }
...
// Black_Layer
Black_Layer::Black_Layer(double arg) : m_dens(clip_to_unit(arg)) {}
...
Black_Layer* Black_Layer::clone() const { return new Black_Layer(*this); }

Color_Base::RGB_Densities Black_Layer::to_rgb() const {
  return Color_Base::RGB_Densities(1 - m_dens, 1 - m_dens, 1 - m_dens);
}

std::string Black_Layer::model() const { return "cmyk"; }
...
Cyan_Layer& Cyan_Layer::blend(const Color_Base& col, double d) { return *this; }
